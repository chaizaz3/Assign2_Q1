...
//-TODO: Step 7 - Uncomment the lines below to include storyData as a private property in StoryBrain. Hint: You might need to change something in story.dart to make this work.
  List<Story> _story = [
    Story(
        'Story Num 0', 'will take you to Story 2', 'will take you to Story 1'),
    Story(
        'Story Num 1', 'will take you to Story 2', 'will take you to Story 3'),
    Story(
        'Story Num 2', 'will take you to Story 5', 'will take you to Story 4'),
    Story('Story Num 3', 'this is the end', 'this is the end'),
    Story('Story Num 4', 'this is the end', 'this is the end'),
    Story('Story Num 5', 'this is the end', 'this is the end'),
  ];
